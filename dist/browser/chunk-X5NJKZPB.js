...
`};var Yo={loader:{mask:{background:"{content.background}",color:"{text.muted.color}"},icon:{size:"2rem"}}};var at=e(r({},c),{components:{accordion:a,autocomplete:t,avatar:n,badge:d,blockui:i,breadcrumb:l,button:s,datepicker:B,card:u,carousel:g,cascadeselect:b,checkbox:f,chip:p,colorpicker:m,confirmdialog:h,confirmpopup:v,contextmenu:k,dataview:C,datatable:x,dialog:w,divider:y,dock:$,drawer:R,editor:z,fieldset:F,fileupload:D,iftalabel:E,floatlabel:_,galleria:S,iconfield:W,image:A,imagecompare:I,inlinemessage:H,inplace:X,inputchips:Y,inputgroup:L,inputnumber:P,inputotp:T,inputtext:G,knob:M,listbox:N,megamenu:O,menu:V,menubar:j,message:q,metergroup:J,multiselect:K,orderlist:Q,organizationchart:U,overlaybadge:Z,popover:no,paginator:oo,password:ao,panel:ro,panelmenu:eo,picklist:to,progressbar:co,progressspinner:io,radiobutton:lo,rating:so,scrollpanel:go,select:bo,selectbutton:fo,skeleton:po,slider:mo,speeddial:ho,splitter:ko,splitbutton:vo,stepper:xo,steps:Co,tabmenu:Bo,tabs:wo,tabview:yo,textarea:zo,tieredmenu:Fo,tag:$o,terminal:Ro,timeline:Do,togglebutton:So,toggleswitch:Wo,tree:Io,treeselect:Ho,treetable:Xo,toast:_o,toolbar:Eo,virtualscroller:Yo,tooltip:Ao,ripple:uo},css:({dt:o})=>`
